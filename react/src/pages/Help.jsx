    ...
    const [faqData] = useState([
        {
            ...
            answer: "Чтобы выйти из аккаунта, нажмите кнопку 'Выйти из аккаунта' в верхней части страницы."
        },
        {
        ...
        },
        {
            ...
            answer: "Вы можете перейти в профиль, нажав кнопку 'Профиль' в верхней части главной страницы сайта."
        },
        {
